document.addEventListener('DOMContentLoaded', () => {
  ...
  const products = [
    ...
    { id: 5, name: 'Algaonema Lipstick', category: 'Outdoor', price: 899, rating: 4.5, description: 'Fragrant blooms that brighten terraces and garden edges.', image: 'https://images.unsplash.com/photo-1525498128493-380d1990a112?auto=format&fit=crop&w=600&q=80' },
    { id: 6, name: 'Spathiphyllum Wallisii', category: 'Outdoor', price: 1199, rating: 4.8, description: 'Lush hanging greenery for balconies and patios.', image: 'https://images.unsplash.com/photo-1501004318641-b39e6451afbe?auto=format&fit=crop&w=600&q=80' },
    { id: 7, name: 'Snake Plant', category: 'Flowering', price: 1899, rating: 4.9, description: 'Elegant flowering stems that add a luxury finish to rooms.', image: 'https://images.unsplash.com/photo-1495231916356-a86217efff12?auto=format&fit=crop&w=600&q=80' },
    { id: 8, name: 'Peacock Plant', category: 'Flowering', price: 1599, rating: 4.7, description: 'A cheerful flowering pick for sunny balconies and courtyards.', image: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&w=600&q=80' },
    { id: 9, name: 'Aglaonema', category: 'Succulents', price: 999, rating: 4.6, description: 'Sculptural succulent with a calm, contemporary look.', image: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=600&q=80' },
    { id: 10, name: 'Anthurium Laceleaf', category: 'Succulents', price: 849, rating: 4.5, description: 'Easy-care succulent prized for wellness and charm.', image: 'https://images.unsplash.com/photo-1463320726281-696a485928c7?auto=format&fit=crop&w=600&q=80' },
